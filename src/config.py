...
# Anv-ke extract: shard-chunked child processes balance speed vs OOM/segfault isolation.
ANV_CLIPS_PER_BATCH = 50
ANV_SHARD_CHUNK_SIZE = 64
ANV_EXTRACT_MAX_WORKERS = 4
ANV_LARGE_EXTRACT_PENDING_THRESHOLD = 2000
ANV_BATCH_TIMEOUT_SEC = 900
